...
```{r}
ggplot(popularityindexvaluesdf, aes(x=numfollowers, y=avgretweets)) + 
  geom_point() +
  geom_smooth() + 
...
```{r}
ggplot(popularityindexvaluesdf, aes(x=numfollowers, y=avgfavorites)) + 
  geom_point() +
  geom_smooth() + 
  labs(title="Number of followers vs. Average Favorites")
```
```{r}
ggplot(popularityindexvaluesdf, aes(x=avgretweets, y=avgfavorites)) + 
  geom_point() +
  geom_smooth() + 
...
senator_personal_information_df
```
...
# Max favorites on a tweet (most popular tweet?)
